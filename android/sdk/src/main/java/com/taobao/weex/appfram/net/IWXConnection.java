...
/**
 * The Network Information API enables web applications to access information about the network
 * connection in use by the device.
 *
...
public interface IWXConnection {
    ...
    String TYPE_CELLULAR = "cellular";
    String TYPE_BLUETOOTH = "bluetooth";
    String TYPE_ETHERNET = "ethernet";
    String TYPE_WIMAX = "wimax";
    String TYPE_MIXED = "mixed";
    String TYPE_NONE = "none";
    String TYPE_UNKNOWN = "unknown";
    String TYPE_OTHER = "other";

    String TYPE_MOBILE_2G = "2g";
    String TYPE_MOBILE_3G = "3g";
    String TYPE_MOBILE_4G = "4g";

    @Retention(RetentionPolicy.SOURCE)
    @StringDef({TYPE_WIFI, TYPE_CELLULAR,
            TYPE_BLUETOOTH, TYPE_ETHERNET, TYPE_WIMAX, TYPE_MIXED, TYPE_NONE,
            TYPE_UNKNOWN, TYPE_OTHER, TYPE_MOBILE_2G, TYPE_MOBILE_3G, TYPE_MOBILE_4G})
    @interface Type {
    }
    ...
    /**
     * 获取网络类型
     * 返回值是2g 3g 4g wifi other none unknown
     * */
    @NonNull
    @Type
    ...
    /**
     * 监听网络状态变化,可以添加多个listener
     * */
    void addNetworkChangeListener(@Nullable OnNetworkChangeListener listener);
