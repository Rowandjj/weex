...
public class WXConnectionModule extends WXSDKEngine.DestroyableModule {
    ...
    private static final String EVENT_NAME = "connectionchange";
            ...
            mWXConnectionImpl.addNetworkChangeListener(new IWXConnection.OnNetworkChangeListener() {
                ...
                public void onNetworkChange() {
                    ...
                    if(mWXSDKInstance != null) {
                        Map<String,Object> emptyMap = new HashMap<>(0);//todo
                        mWXSDKInstance.fireGlobalEventCallback(EVENT_NAME, emptyMap);
                    }
                }
            });
        }
